  ...
  return (
    <div className="w-full min-h-screen bg-background">
      <header className="bg-card shadow-md border-b border-border sticky top-0 z-10">
        <div className="max-w-7xl mx-auto py-4 sm:py-6 px-3 sm:px-4 md:px-6 lg:px-8 flex items-center gap-2 sm:gap-4">
      ...
      <div className="max-w-7xl mx-auto py-4 sm:py-6 md:py-8 px-3 sm:px-4 md:px-6 lg:px-8">
        <div className="bg-card p-4 sm:p-6 md:p-8 rounded-xl shadow-lg border border-border/40 transition-all duration-300 hover:shadow-xl hover:border-border space-y-4 sm:space-y-6 md:space-y-8">
          <section>
            ...
            <p className="text-muted-foreground text-base sm:text-lg leading-relaxed">
              ...
              management of client feedback. Our mission is to provide
              actionable insights that enhance service quality and engagement.
              This project is created by Ahnaf Farhan Hossain, a senior Frontend
              Developer and Designer at TechShabaka, a leading web-dev agency in
              Bangladesh.
            </p>
          </section>

          <section>
            <h3 className="text-lg sm:text-xl font-semibold text-foreground mb-3 sm:mb-4 flex items-center gap-2 sm:gap-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
            ...
            <div className="bg-muted/50 p-3 sm:p-4 md:p-6 rounded-lg border border-border/40">
              <p className="text-muted-foreground text-sm sm:text-base leading-relaxed mb-3 sm:mb-4">
                Feedlytic uses Supabase as its database and backend to store and
                edit data for the app. The user can connect their SaaS or any
                desired application with this app's Supabase URL -{" "}
                <code className="px-1.5 sm:px-2 py-0.5 sm:py-1 bg-primary/10 text-primary rounded font-mono text-xs sm:text-sm break-all">
                  https://zklzsjtbtlmmefzjquzm.supabase.co
                </code>{" "}
                and then collect feedbacks/testimonials via any form or survey.
                This app uses real-time data collection thus the user can easily
                manage the feedbacks instantly after the data has been input
                into the database.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {[
                ...
                <li
                  key={index}
                  className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-muted/50 rounded-lg border border-border/40 transition-colors duration-200 hover:bg-muted/70"
                >
